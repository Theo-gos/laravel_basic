    ...
    <form class="w-full max-w-lg border-2 p-3 border-gray-200 mx-auto form" action="{{$item->id ? route('users.item.edit', ['id' => $item->id]) : route('users.item.add')}}" method="POST">
        ...
        <div class="flex flex-wrap -mx-3 mb-6 justify-between">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0 flex-grow">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" required="" name="title" id="title" type="text" value="{{$item->title}}">
            ...
            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <div class="relative">
                    <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="priority" id="priority" value="{{$item->priority}}">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
                ...
                <textarea class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 h-48" required="" name="description" id="description">{{$item->description}}</textarea>
                <p class="error-p text-red-500 text-xs italic hidden"></p>
            </div>
        </div>
        <div class="flex flex-wrap -mx-3 mb-2">
            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0 flex-grow">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="duedate" id="duedate" type="date" required="" value="{{$item->duedate}}">
                <p class="error-p text-red-500 text-xs italic hidden"></p>
            </div>
        </div>
