<x-main-layout>
    <x-slot name="header">
        ...
        <!-- <a href="lists/add" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline rounded mx-2 mt-3 block w-fit mb-1">Add An Item</a> -->
    </x-slot>
    ...
    <div class="to-do-list striped flex flex-col justify-between items-start">
        <div class="to-do-heading grid grid-cols-12 gap-2 border-y-2 border-black w-full text-center">
            ...
            <div class="grid-cols-subgrid col-span-8 border-x-2 border-black">
                Item Info
            </div>
        ...
        <div class="to-do-item grid grid-cols-12 gap-2 border-b-2 border-black w-full">
            ...
            <div class="item_info grid-cols-subgrid col-span-8 p-2 border-x-2 border-black">
                <p class="item_title text-2xl">{{$item->title}}</p>
                <p class="item_desc text-gray-500 overflow-hidden">{{$item->description}}</p>
                <p class="item_desc text-sm text-gray-500 overflow-hidden">{{$item->create_date}}</p>
            </div>
            ...
            <!-- <div class="item_controls grid-cols-subgrid col-span-2 px-1 border-r-2 border-black flex justify-center items-center">
                <a href="lists/edit/{{$item->id}}" class="bg-yellow-500 hover:bg-yellow-400 text-gray-800 font-bold py-2 px-4 rounded mx-1">Edit</a>
                <a href="lists/delete/{{$item->id}}" class="bg-red-500 hover:bg-red-400 text-gray-800 font-bold py-2 px-4 rounded mx-1">Delete</a>
            </div> -->
        </div>
        @endforeach
    </div>
